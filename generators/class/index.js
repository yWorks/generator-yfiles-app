...
module.exports = class extends Generator {
  writing() {
    ...
    const vars = {
      ...
      layout: modules.indexOf('layout-hierarchic') >= 0 ? (language === "javascript" ? 'yfiles.hierarchic.HierarchicLayout' : 'HierarchicLayout') : false,
      ...
      useDevLib: this.options.useDevLib,
